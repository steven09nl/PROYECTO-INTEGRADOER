...
public class PracticeRequest {
    ...
    public PracticeRequest(Long idPractica, String nombre, String tipoPractica, Integer horasReglamentarias, String estado, java.time.LocalDate fechaInicio, java.time.LocalDate fechaFin, String semestre) {
