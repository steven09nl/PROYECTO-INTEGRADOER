...
public class BitacoraRequest {
    ...
    public BitacoraRequest() {}

    public BitacoraRequest(Long idEstudiante, Long idPractica, String estado, String modalidad, java.time.LocalDate fechaEnvio, Double calificacion) {
