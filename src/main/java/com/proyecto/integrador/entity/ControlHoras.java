...
public class ControlHoras {
    ...
    public ControlHoras(Long idRegistro, Long idBitacora, java.time.LocalDate fecha, java.time.LocalTime horaEntrada, java.time.LocalTime horaSalida, Double horasCumplidas) {
